...
- [Penggunaan *Route* dengan cara classic](#function)
...
Sekarang buka lagi file `index.php` tadi. Lalu tambahkan syntax berikut didalamnya :
...
##<a name="function"></a>Penggunaan *Route* dengan cara classic
...
<figure>
	<center>
		<a href="{{ site.url }}/assets/post/2014-05-06-hello-slim-framework-4.PNG" target="_blank"> 
			<img src="{{ site.url }}/assets/post/2014-05-06-hello-slim-framework-4.PNG" width="500px"/>
		</a>
		<figcaption>Hello Slim cara Classic</figcaption>
	</center>
</figure>
...
Source Code lihat di [GitHub](https://github.com/novay/hello-slim)